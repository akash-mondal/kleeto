...
/**
 * Product artwork from getsolari.com, the provider Kleeto's machines run on.
...
export const SOLARI_APP_ICONS = [
  { name: "Google Chrome", src: "/images/showcase/chrome-original-a1c178.svg" },
  { name: "Slack", src: "/images/showcase/slack-original-222a01.svg" },
  { name: "Salesforce", src: "/images/showcase/salesforce-original-811c4c.svg" },
  { name: "Visual Studio Code", src: "/images/showcase/vscode-original-aba887.svg" },
] as const;
