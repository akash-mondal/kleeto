 ...
 */
const GITHUB = "https://github.com/akash-mondal/kleeto";
const X = "https://x.com/akshmnd";
...
const COLUMNS: readonly { title: string; links: readonly { label: string; href: string }[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Install the skill", href: "https://github.com/akash-mondal/kleeto-skill" },
      { label: "Verify a bill", href: "/#receipt" },
      { label: "Agent card", href: "https://api.kleeto.fun/.well-known/agent-card.json" },
      { label: "FAQ", href: "/#faq" },
    ],
  },
  {
    ...
    links: [
      ...
      { label: "X", href: X },
      { label: "x402 on Hedera", href: "https://docs.hedera.com/solutions/ai/x402" },
    ],
  },
];
        ...
        <div className="overflow-hidden rounded-[28px] bg-[var(--kl-card-deep)] px-6 py-10 md:px-10 md:py-12">
          <div className="grid gap-10 md:grid-cols-[minmax(0,1fr)_auto] md:gap-16">
            <div className="max-w-[34ch]">
              <KleetoLockup className="text-kl-on-card" href="/" />
