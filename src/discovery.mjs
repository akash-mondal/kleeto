  ...
  return {
    ...
    paying: {
      order: [
        ...
        "kleeto_deliver — copy a finished file off the machine so the person keeps it. Do this before returning.",
      ...
      deliverables: "A rented machine is gone when it goes back, and so is everything on it. kleeto_deliver copies a file into the run's own folder first, and the person watching gets a download link.",
